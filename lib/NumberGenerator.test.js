...
describe('NumberGenerator', () => {
  describe('without batches', () => {
    it('sets new numbers', () => {
      const numberGenerator = new NumberGenerator(allDigitsByOneGenerator(3));
  ...
  describe('in batches', () => {
    it('sets new numbers', () => {
      const numberGenerator1 = new NumberGenerator(allDigitsByOneGenerator(8), {
        batchLength: 2,
        batchNumber: 0,
        variationsCount: numbers => 3,
      });

      const numberGenerator2 = new NumberGenerator(allDigitsByOneGenerator(8), {
        batchLength: 2,
        batchNumber: 1,
        variationsCount: numbers => 3,
      });

      const numberGenerator3 = new NumberGenerator(allDigitsByOneGenerator(8), {
        batchLength: 2,
        batchNumber: 2,
        variationsCount: numbers => 3,
      });
